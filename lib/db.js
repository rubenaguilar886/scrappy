...
-- Prueba gratis SIN login: identificada por el session id del navegador
-- (mismo header X-Scrappy-Session que ya se usa para aislar búsquedas
-- entre usuarios), no por una cuenta. Permite buscar de una sola vez sin
-- pedir correo — recién se pide login para la SIGUIENTE búsqueda o compra.
